...
import de.clemensbartz.chattychimpchat.core.ChimpException;
import de.clemensbartz.chattychimpchat.core.ChimpView;
...
public class ChimpManager {
     ...
     * @throws java.io.IOException if there is an issue setting up the sockets
     */
